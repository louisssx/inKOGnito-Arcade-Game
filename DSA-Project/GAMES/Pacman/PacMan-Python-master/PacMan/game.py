...
class Game(object):
    def __init__(self):
        ...
        # Create the player
        self.player = Player(32,128,"resources\pacman assets\player.png")
        ...
        self.pacman_sound = pygame.mixer.Sound("resources\pacman assets\pacman_sound.ogg")
        self.game_over_sound = pygame.mixer.Sound("resources\pacman assets\game_over_sound.ogg")
