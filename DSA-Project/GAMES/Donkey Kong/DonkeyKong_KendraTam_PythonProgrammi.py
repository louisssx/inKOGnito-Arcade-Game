...
#Define Images
title = pygame.image.load("resources/donkey assets/title-screen.png")
start = pygame.image.load("resources\donkey assets\start.png")
winScreen = pygame.image.load("resources\donkey assets\win-screen.png")
gameOverScreen = pygame.image.load("resources\donkey assets\game-over-screen.png")

selectIcon = pygame.image.load("resources\donkey assets\select-icon.png")
life = pygame.image.load("resources\donkey assets\mario-life.png")

withLadder = pygame.image.load("resources\donkey assets\withLadder.png")
platform0 = pygame.image.load("resources\donkey assets\platform0.png")
platform1 = pygame.image.load("resources\donkey assets\platform1.png")
platform2 = pygame.image.load("resources\donkey assets\platform2.png")
platform3 = pygame.image.load("resources\donkey assets\platform3.png")
platform4 = pygame.image.load("resources\donkey assets\platform4.png")
platform5 = pygame.image.load("resources\donkey assets\platform5.png")
platform6 = pygame.image.load("resources\donkey assets\platform6.png")
platforms = [platform0, platform1, platform2, platform3, platform4, platform5, platform6]
level = pygame.image.load("resources\donkey assets\level.png")

blue0 = pygame.image.load("resources\donkey assets/blue0.png")
blue1 = pygame.image.load("resources\donkey assets/blue1.png")
blue2 = pygame.image.load("resources\donkey assets/blue2.png")
blue3 = pygame.image.load("resources\donkey assets/blue3.png")
blue4 = pygame.image.load("resources\donkey assets/blue4.png")
blue5 = pygame.image.load("resources\donkey assets/blue5.png")
blueNumbers = [blue0, blue1, blue2, blue3, blue4, blue5]
white0 = pygame.image.load("resources\donkey assets\white0.png")
white1 = pygame.image.load("resources\donkey assets\white1.png")
white2 = pygame.image.load("resources\donkey assets\white2.png")
white3 = pygame.image.load("resources\donkey assets\white3.png")
white4 = pygame.image.load("resources\donkey assets\white4.png")
white5 = pygame.image.load("resources\donkey assets\white5.png")
white6 = pygame.image.load("resources\donkey assets\white6.png")
white7 = pygame.image.load("resources\donkey assets\white7.png")
white8 = pygame.image.load("resources\donkey assets\white8.png")
white9 = pygame.image.load("resources\donkey assets\white9.png")
whiteNumbers = [white0, white1, white2, white3, white4, white5, white6, white7, white8, white9]

marioLeft = pygame.image.load("resources\donkey assets\mario-left.png")
marioRight = pygame.image.load("resources\donkey assets\mario-right.png")
runLeft = pygame.image.load("resources\donkey assets/run-left.png")
runRight = pygame.image.load("resources\donkey assets/run-right.png")
marioJumpLeft = pygame.image.load("resources\donkey assets\jump-left.png")
marioJumpRight = pygame.image.load("resources\donkey assets\jump-right.png")
marioClimb1 = pygame.image.load("resources\donkey assets\marioClimb1.png")
marioClimb2 = pygame.image.load("resources\donkey assets\marioClimb2.png")
dead = pygame.image.load("resources\donkey assets\dead.png")
marioImage = marioRight

paulineHelp = pygame.image.load("resources\donkey assets\pauline-help.png")
paulineStill = pygame.image.load("resources\donkey assets\pauline-still.png")

dkUp1 = pygame.image.load("resources\donkey assets\DK_up1.png")
dkUp2 = pygame.image.load("resources\donkey assets\DK_up2.png")
dkEmptyClimb1 = pygame.image.load("resources\donkey assets\dkClimbEmpty1.png")
dkEmptyClimb2 = pygame.image.load("resources\donkey assets\dkClimbEmpty2.png")
dkForward = pygame.image.load("resources\donkey assets\dkForward.png")
dkLeft = pygame.image.load("resources\donkey assets\dkLeft.png")
dkRight = pygame.image.load("resources\donkey assets\dkRight.png")
dkDefeat = pygame.image.load("resources\donkey assets\DK-defeat.png")
dkImage = dkForward

barrelStack = pygame.image.load("resources\donkey assets/barrel-stack.png")
barrelDown = pygame.image.load("resources\donkey assets/barrel-down.png")
barrel1 = pygame.image.load("resources\donkey assets/barrel1.png")
barrel2 = pygame.image.load("resources\donkey assets/barrel2.png")
barrel3 = pygame.image.load("resources\donkey assets/barrel3.png")
barrel4 = pygame.image.load("resources\donkey assets/barrel4.png")
barrelSequence = [barrel1, barrel2, barrel3, barrel4]
barrelPic = []

brokenHeart = pygame.image.load("resources\donkey assets/broken-heart.png")
fullHeart = pygame.image.load("resources\donkey assets/full-heart.png")
...
pygame.init()
walk = pygame.mixer.Sound("resources\donkey assets\walking\\walking.wav")
jump = pygame.mixer.Sound("resources\donkey assets\jump\\jump.wav")
intro = pygame.mixer.Sound("resources\donkey assets\intro1\\intro1.wav")
death = pygame.mixer.Sound("resources\donkey assets\death\\death.wav")
bac = pygame.mixer.music.load("resources\donkey assets/bacmusic\\bacmusic.wav")
death_cnt = 0
